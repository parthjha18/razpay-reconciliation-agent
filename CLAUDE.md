...
- **AI layer:** Direct Claude API calls with structured tool-calling for Layers 3-4 — a single well-designed agent step, not an over-engineered multi-agent framework. Simplicity here is a feature, not a shortcut.
